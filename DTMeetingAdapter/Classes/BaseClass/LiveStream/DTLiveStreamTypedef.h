...
typedef NS_ENUM(NSUInteger, DTRTCConnectionState) {
    DTRTCConnectionStateDisconnected = 1,
    DTRTCConnectionStateConnecting = 2,
    DTRTCConnectionStateConnected = 3,
    DTRTCConnectionStateReconnecting = 4,
    DTRTCConnectionStateFailed = 5,
    DTRTCConnectionStateUnknow = 1000,
};

typedef NS_ENUM(NSUInteger, DTRTCConnectionChangedReason) {
    DTRTCConnectionChangedReasonConnecting = 0,
    DTRTCConnectionChangedReasonJoinSuccess = 1,
    DTRTCConnectionChangedReasonInterrupted = 2,
    DTRTCConnectionChangedReasonBannedByServer = 3,
    DTRTCConnectionChangedReasonJoinFailed = 4,
    DTRTCConnectionChangedReasonLeaveChannel = 5,
    DTRTCConnectionChangedReasonInvalidAppId = 6,
    DTRTCConnectionChangedReasonInvalidChannelName = 7,
    DTRTCConnectionChangedReasonInvalidToken = 8,
    DTRTCConnectionChangedReasonTokenExpired = 9,
    DTRTCConnectionChangedReasonRejectedByServer = 10,
    DTRTCConnectionChangedReasonSettingProxyServer = 11,
    DTRTCConnectionChangedReasonRenewToken = 12,
    DTRTCConnectionChangedReasonClientIpAddressChanged = 13,
    DTRTCConnectionChangedReasonKeepAliveTimeout = 14,
    DTRTCConnectionChangedReasonRejoinSuccess = 15,
    DTRTCConnectionChangedReasonLost = 16,
    DTRTCConnectionChangedReasonEchoTest = 17,
    DTRTCConnectionChangedReasonClientIpAddressChangedByUser = 18,
    DTRTCConnectionChangedReasonSameUidLogin = 19,
    DTRTCConnectionChangedReasonTooManyBroadcasters = 20,
    DTRTCConnectionChangedReasonLicenseValidationFailure = 21,
    DTRTCConnectionChangedReasonUnknow = 1000,
};
