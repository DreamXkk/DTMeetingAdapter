...
/// @param state 流的状态
/// @param reason 更新原因
- (void)onRecvConnectionChangedToState:(NSString * _Nullable)streamId state:(DTRTCConnectionState)state reason:(DTRTCConnectionChangedReason)reason;
